...
class FindMyVaccine(App):
    ...
    def construct_ui(self):
        ...
        labelVersion.text = "VaxSure (version 0.2)"
    ...
    def init_ui(self):
        ...
        self.labelVersion.set_text(f"VaxSure(v{__version__})")
...
if __name__ == "__main__":
    ...
    start(FindMyVaccine, standalone=True, resizable=False, height=800, width=600)